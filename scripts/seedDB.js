...
const dashSeed = [
  ...
  // },
  // {
  //   Make: "Harry Potter and the Sorcerer's Stone",
  //   Model: "J.K. Rowling",
  //   synopsis:
  ...
  // },
  // {
  //   Make: "Code: The Hidden Language of Computer Hardware and Software",
  //   Model: "Charles Petzold",
  //   synopsis:
  //     "What do flashlights, the British invasion, black cats, and seesaws have to do with computers? In CODE, they show us the ingenious ways we manipulate language and invent new means of communicating with each other. And through CODE, we see how this ingenuity and our very human compulsion to communicate have driven the technological innovations of the past two centuries. Using everyday objects and familiar language systems such as Braille and Morse code, Model Charles Petzold weaves an illuminating narrative for anyone who’s ever wondered about the secret inner life of computers and other smart machines. It’s a cleverly illustrated and eminently comprehensible story—and along the way, you’ll discover you’ve gained a real context for understanding today’s world of PCs, digital media, and the Internet. No matter what your level of technical savvy, CODE will charm you—and perhaps even awaken the technophile within.",
  //   date: new Date(Date.now())
  // },
  // {
  //   Make: "The Everything Store: Jeff Bezos and the Age of Amazon",
  //   Model: "Brad Stone",
  //   synopsis:
  ...
  // },
  // {
  //   Make: "Total Recall: My Unbelievably True Life Story",
  ...
  // },
  // {
  //   Make: "Astrophysics for People in a Hurry",
  //   Model: "Neil deGrasse Tyson",
  //   synopsis:
  //     "What is the nature of space and time? How do we fit within the universe? How does the universe fit within us? There's no better guide through these mind-expanding questions than acclaimed astrophysicist and best-selling Model Neil deGrasse Tyson. But today, few of us have time to contemplate the cosmos. So Tyson brings the universe down to Earth succinctly and clearly, with sparkling wit, in digestible chapters consumable anytime and anywhere in your busy day. While waiting for your morning coffee to brew, or while waiting for the bus, the train, or the plane to arrive, Astrophysics for People in a Hurry will reveal just what you need to be fluent and ready for the next cosmic headlines: from the big bang to black holes, from quarks to quantum mechanics, and from the search for planets to the search for life in the universe.",
  //   date: new Date(Date.now())
  // },
  // {
  //   Make: "1984",
  ...
  // },
  // {
  //   Make: "Born a Crime: Stories from a South African Childhood",
  //   Model: "Trevor Noah",
  //   synopsis:
